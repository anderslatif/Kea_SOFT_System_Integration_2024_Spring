...
* Can do basic operations in Redis in the CLI. 
...
a|
link:00._Course_Material/01._Assignments/10._Event-driven_architecture/10a._SMS_Integration.md[10a SMS Integration]

link:00._Course_Material/01._Assignments/10._Event-driven_architecture/10a._Email_Integration.md[10a Email Integration]

// todo graphQL assignment
