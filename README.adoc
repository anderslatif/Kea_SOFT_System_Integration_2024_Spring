...
link:00._Course_Material/01._Assignments/09._Documentation_Event-driven_architecture/09a._Generate_Code_Documentation_For_DLS.md[09b <DLS Group> Create Code Documentation for DLS]
...
*  
a|
link:00._Course_Material/01._Assignments/10._WebScraping_GraphQL/10a._GraphQL.md[10a GraphQL]
